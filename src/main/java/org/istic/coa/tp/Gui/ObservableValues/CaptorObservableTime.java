 ...
 */
public class CaptorObservableTime implements ObservableStringValue {
    ...
    public CaptorObservableTime(Captor captor) {
        this.captor = captor;
    }
    ...
    public String getValue() {
        return String.valueOf(captor.getValues().getTime());
    }
